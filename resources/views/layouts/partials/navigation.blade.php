<div class="bg-gray-800" x-data="{ open: false }">
    <div class="flex justify-between flex-col md:flex-row items-center">
        ...
        <div class="flex justify-between w-full md:w-auto px-4 py-4 bg-gray-900 md:bg-transparent md:border-b-0">
            <div>
            ...
            <div class="flex flex-col md:flex-row md:items-center"> 
                @auth
                    <div x-data="{ dropdownIsOpen: false }" class="border-t border-gray-600 py-4 md:py-0">
                        ...
                        <div :class="{ 'md:hidden': !dropdownIsOpen  }" class="block md:absolute top-0 right-0 md:mr-4 mt-2 md:mt-14 md:bg-gray-700 md:w-56 md:rounded md:shadow md:py-2 leading-relaxed md:leading-loose">
